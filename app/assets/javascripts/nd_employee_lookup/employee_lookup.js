...
function build_employee_selection (input) {
  ...
  emp_string += ' <div class="large-2 medium-1 small-3 columns left"><label class="text_nw">NetID:</label></div>';
  ...
  emp_string += ' </div>';
  emp_string += ' <div class="row ldc_display">';
  emp_string += ' <div class="large-2 medium-1 small-3 columns left"><label class="text_nw">ndID:</label></div>';
